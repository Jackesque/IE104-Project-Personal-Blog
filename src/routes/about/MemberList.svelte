...
<div class='mt-20'>
    ...
    <div class='grid grid-cols-3 gap-3'>
        ...
        <div class='flex flex-col items-center'>
            ...
            <h2 class='text-xl'>MSSV: 21522673</h2>
        </div>
        <div class='flex flex-col items-center'>
            <img class='w-80 m-3 rounded-md' src='{base}/images/ava3.jpg' alt='Thai2'/>
            <h1 class='text-2xl font-medium m-1'>Đào Duy Thái</h1>
            <h2 class='text-xl'>MSSV: 21522578</h2>
        </div>
    </div>
</div>